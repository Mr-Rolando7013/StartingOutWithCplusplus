...
$.10 each for fewer than 20 checks $.08 each for 20-39 checks $.06 each for 40-59 checks 
...
If a negative value is given for the beginning balance, display an urgent message indicating 
